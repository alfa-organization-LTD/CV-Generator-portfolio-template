...
const About: React.FC = () => {
  ...
  return (
    <div className="about py-10 flex flex-col items-center text-center dark:bg-[#121212] dark:text-[#EAEAEA] px-4 md:px-10">
      {/* Heading */}
      ...
      <div className="space-y-4 text-lg">
        ...
        <div className="flex items-center gap-2 justify-center">
          ...
          <span>:</span>
          <a
            href="https://wa.me/201067564254"
            className="hover:underline flex items-center gap-1 text-[#FF2E63]"
            target="_blank"
        ...
        <div className="flex items-center gap-2 justify-center">
          ...
          <span>:</span>
          <a
            href="mailto:zeyadali011@gmail.com"
            className="hover:underline flex items-center gap-1 text-[#FF2E63]"
          >
      ...
      <form
        ref={formRef}
        onSubmit={sendEmail}
        className="w-full max-w-xl space-y-6 bg-[#1A1A1D] p-6 rounded-lg shadow-md"
      >
        {/* Name */}
        <div className="text-left">
          ...
          <input
            ...
            className="w-full p-2 rounded-md bg-[#333333] text-white focus:outline-none focus:ring-2 focus:ring-[#FF2E63]"
          />
        </div>
        ...
        <div className="text-left">
          ...
          <textarea
            ...
            className="w-full p-3 rounded-md resize-none bg-[#333333] text-white focus:outline-none focus:ring-2 focus:ring-[#FF2E63]"
          />
        </div>
        ...
        <div className="text-center">
          <button
            type="submit"
            className="px-6 py-2 bg-[#FF2E63] hover:bg-[#99050d] text-white rounded-md transition"
          >
            Send
          </button>
        </div>
