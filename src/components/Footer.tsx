...
const Footer = () => {
  return (
    <motion.footer
      className="flex flex-col items-center p-5 mt-10 rounded-t-2xl bg-[#1A1A1D] text-[#EAEAEA]"
    ...
    >
      ...
      <div className="flex space-x-5 p-5">
        {/* GitHub Link */}
        <a href="https://github.com/zeiadsalhin" aria-label="Zeiad's Github" target="_blank" rel="noopener noreferrer">
        ...
        {/* LinkedIn Link */}
        <a href="https://www.linkedin.com/in/zeiad-abdeltawab-a20457236/" aria-label="Zeiad's Linkedin" target="_blank" rel="noopener noreferrer">
      ...
      <p className="text-[#B6B6B6]">Made with ❤ by Ziad</p>
    </motion.footer>
  );
};
